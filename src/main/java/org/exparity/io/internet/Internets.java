...
public abstract class Internets {
     ...
     * Obtain an instance of a {@link Internet} which is connected to the <i>real</i> internet
     */
    public static Internet newInstance(final int connTimeout,
    ...
    /**
     * Obtain an instance of a {@link Internet} which is connected to the <i>real</i> internet but is read through a
     * read through cache and uses the local cached version if found
     */
    ...
    public static Internet newCachedInstance(final String cacheDir,
            ...
            final int readTimeout,
            final TimeUnit readTimeUnit) {
        return new InternetWithCacheImpl(new InternetPhysicalImpl(connTimeout, connTimeUnit, readTimeout, readTimeUnit),
                cacheDir);
    }
